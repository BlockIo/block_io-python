...
You can install it like so on Windows: "pip install block-io==1.1.4"  
...
Now exit your Command Prompt or Python IDE, go to Command Prompt again, type "pip install block-io==1.1.4". 
